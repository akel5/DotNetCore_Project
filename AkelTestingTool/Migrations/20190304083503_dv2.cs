        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PDescription = table.Column<string>(maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BugStatus = table.Column<string>(maxLength: 150, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BugsSummary", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BugsSummary_Projects_ProjectsPId",
                        column: x => x.ProjectsPId,
                        principalTable: "Projects",
                        principalColumn: "PId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BugsSummary_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BugsSummary_ProjectsPId",
                table: "BugsSummary",
                column: "ProjectsPId");

            migrationBuilder.CreateIndex(
                name: "IX_BugsSummary_UserId",
                table: "BugsSummary",
                column: "UserId");
        }
